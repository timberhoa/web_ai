...
public class DashboardService {
        ...
        private static final List<Attendance.Status> PRESENT_STATUSES = Arrays.asList(Attendance.Status.PRESENT,
                        Attendance.Status.LATE, Attendance.Status.EXCUSED);
        ...
        public TeacherDashboardResponse getTeacherDashboard(UUID teacherId) {
                ...
                List<ClassSessionResponse> upcomingSessions = classSessionRepository
                                .findTop5ByCourse_Teacher_IdAndStartTimeGreaterThanEqualOrderByStartTimeAsc(teacherId,
                                                startOfDay)
                                .stream()
        ...
        public StudentDashboardResponse getStudentDashboard(UUID studentId) {
                ...
                long todayCheckins = attendanceRepository.countByStudent_IdAndCheckedAtBetween(studentId, startOfDay,
                                endOfDay);
