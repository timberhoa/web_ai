        ...
        CommandLineRunner seedData(
                ...
                return args -> {
                        ...
                        classSessionRepository.saveAll(
                                        java.util.Arrays.asList(session1, session2, session3, session4, session5));
                        ...
                        enrollmentRepository.saveAll(java.util.Arrays.asList(
                        ...
                        attendanceRepository.saveAll(java.util.Arrays.asList(
                        ...
                        courseLecturerRepository.saveAll(java.util.Arrays.asList(cl1, cl2, cl3, cl4, cl5, cl6));
                        ...
                        System.out.println(
                                        "   - 15 Students created (IT: 5, Business: 3, Engineering: 4, Medicine: 2, Arts: 1)");
